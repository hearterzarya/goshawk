...
import { shipperFAQs } from '@/data/faqs'
...
const benefits = [
  {
    icon: Clock,
    title: 'Fast Quotes',
    description: 'Get competitive quotes within hours, not days.',
  },
  {
    icon: Shield,
    title: 'Verified Carriers',
    description: 'All carriers are licensed, insured, and safety-verified.',
  },
  {
    icon: TrendingUp,
    title: 'Cost Savings',
    description: 'Access to competitive rates through our carrier network.',
  },
  {
    icon: Headphones,
    title: '24/7 Support',
    description: 'Round-the-clock dispatch and tracking assistance.',
  },
]
        ...
        <Container>
          ...
          >
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-display font-bold text-navy-900 mb-6 leading-tight">
              Shipping Solutions for Shippers
            </h1>
            <p className="text-xl sm:text-2xl text-navy-600 leading-relaxed max-w-3xl mx-auto">
              Streamlined freight brokerage services designed to simplify your
              shipping operations. Get competitive rates, reliable carriers, and
              peace of mind.
            </p>
          </div>
        </Container>
